...
import Typography from '../general/typography'; // Fixed the import statement
import Container from '../layout/container';
import useWindowSize from '../hooks/use-window-size';
import { copyTextToClipboard } from '../lib/utils';

let email = 'ashutoshkumarjha500@gmail.com';
let phone = '+91 8969823422';

const ContactSection = () => {
  const { width } = useWindowSize();
  const [isCopied, setIsCopied] = useState(false);
  const [copiedValueType, setCopiedValueType] = useState(null); // Removed TypeScript type

  const handleCopyClick = async (text, type) => { // Removed TypeScript types
    try {

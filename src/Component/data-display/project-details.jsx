...
const ProjectDetails = ({
  ...
  return (
    <Card className="mx-auto dark:bg-gray-800 flex w-full max-w-6xl flex-col md:flex-row">
      {/* Image */}
      <div
        className={mergeClasses(
          'flex items-center justify-center border-gray-100 bg-gray-50 p-8 dark:bg-gray-600 max-md:rounded-t-xl md:w-1/2 lg:p-12',
          layoutType === 'default'

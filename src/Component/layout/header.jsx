...
const Logo = () => (
  <Typography variant="h3" className="font-bold dark:text-gray-100">
    {'Ashu'}
  </Typography>
);
...
const Header = () => {
  ...
  // Close sidebar if open and screen size is larger than 768px
  useEffect(() => {
        ...
        <Drawer isOpen={isOpen} onClose={toggleDrawer} >
          ...
          <div className="h-full flex flex-col gap-4 p-4">
            <div className="flex items-center justify-between">
              <Typography className="text-gray-900"> Switch Theme</Typography>
              <ThemeSwitcher />
            </div>
            <DownloadCV />
          </div>
